...
Frontendant to build a simple React frontend. Nothing fancy, just something that actually uses the API so I can see it working end-to-end.
...
What I Learnedrtable with Django's ORM and querysets. Understanding foreign keys, ManyToMany relationships, and when to use them.
